...
let BRAND = {
    app: {
        language: 'en',
        name: 'Hankamrata Talk',
        title: 'Hankamrata Talk<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
    ...
    site: {
        title: 'Hankamrata Talk, Free Video Calls, Messaging and Screen Sharing',
    ...
    meta: {
        description:
            'Hankamrata Talk powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
    ...
    about: {
        ...
        title: '<strong>WebRTC SFU v2.0.46</strong>',
        html: `
            <button 
                id="support-button" 
            ...
            <a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=Hankamrata Talk info"> 
                miroslav.pejic.85@gmail.com
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2025 Hankamrata Talk, all rights reserved</span>
            <hr />
        `,
    },
    widget: {
        ...
        supportWidget: {
            ...
            customMessages: {
                ...
                poweredBy: 'Powered by Hankamrata Talk',
            },
            alert: {
                enabled: false,
                type: 'email',
